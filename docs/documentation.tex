...
They are all uncommented by default except for \texttt{enable\_uart=1} which enables the UART, and \texttt{dtparam=i2c\_arm=on} which enables the I$^2$C.
...
\begin{figure}[h]
    \includegraphics[width=12.1cm]{i2c_lcd}
    \centering
